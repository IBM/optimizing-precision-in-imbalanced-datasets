...
class DataLoader:
    def __init__(self, config, logger):
        ...
        logging.info('[DATALOADER]: Initializing Optical Digits Dataloader')
        self.config = config
        ...
        self.train_data = pd.read_csv(cfg.train_path, header=None)
        self.test_data = pd.read_csv(cfg.test_path, header=None)
    ...
    def get_data(self):
        ...
        X_test, y_test = self.test_data.iloc[:, :-1], self.test_data.iloc[:, -1]
